...
|![書籍登録方法選択画面](https://github.com/user-attachments/assets/8402d839-6315-4d8f-a1f0-43fa9f4a7966)|FABをクリックすると遷移します。書籍の登録方法を選択する画面で、タイトルによる検索と書籍背面のバーコードを読み込んでの検索を選択することができます。|
